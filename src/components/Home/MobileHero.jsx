                ...
                <div className=" hero_slide_4_mob overflow-hidden scale-[0.0001]  bg-[#FFFDF6] w-full h-full absolute z-[5]">
                    <div className="w-full h-screen relative flex-col gap-10 center text-center ">
                        <div className=" about_div_mob flex-col w-full h-full gap-10 center text-center">
                            ...
                            <div className=" text-xl lg:text-5xl flex flex-col  items-center   capitalize">
                                <div className='block relative overflow-hidden lg:pb-2'>
                                    <div className=" opa_slide_1_mob absolute top-1 left-[32%] w-full h-full bg-[#fffdf6c0]"></div>
                                    <p>
                        ...
                        <div className="sq_img_1_mob aspect-square overflow-hidden absolute z-[1] bottom-[-40vw] lg:bottom-[-15vw] right-3 lg:right-10 w-[40vw] md:w-[15vw]">
                            <img
                                src="/Images/HomePage/heroSlider/About_1_mob.webp"
                                alt="loading"

                                className="sq_img_in_1_mob  w-full h-full object-cover"
                            />
                        </div>

                        <div className="sq_img_2_mob aspect-square overflow-hidden absolute z-[1] bottom-[-40vw] lg:bottom-[-15vw] left-3 lg:left-10 w-[40vw] md:w-[15vw]">
                            <img
                                src="/Images/HomePage/heroSlider/About_2_mob.webp"
                                alt="loading"

                                className="sq_img_in_2_mob  w-full h-full object-cover"
                            />
                        </div>

                        <div className="sq_img_3_mob aspect-square overflow-hidden absolute z-[1] bottom-[-40vw] lg:bottom-[-15vw] left-1/2 -translate-x-1/2 w-[40vw] md:w-[15vw]">
                            <img
                                src="/Images/HomePage/heroSlider/About_3_mob.webp"
                                alt="loading"

                                className="sq_img_in_3_mob  w-full h-full object-cover"
                            />
                        </div>
